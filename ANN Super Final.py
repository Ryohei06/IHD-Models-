...
model = keras.Sequential([
  keras.layers.Dense(4, activation="relu", input_shape=(8,)),  # Hidden layer with 4 units and ReLU activation
...
# Assuming you have a threshold value between 0 and 1 (e.g., 0.5)
threshold = 0.5

#Make predictions on the test data (or any new unseen data)
y_pred = model.predict(X_test)
...
y_pred = binarizer.fit_transform(y_pred.reshape(-1, 1))  # Reshape for Binarizer
